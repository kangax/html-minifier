...
(function(global) {
  ...
  var HTMLParser = global.HTMLParser = function( html, handler ) {
    ...
    function handleStartTag(match) {
      ...
      if (handler.html5 && lastTag && phrasingOnly[lastTag] && !phrasing[tagName] && isKnownTag(tagName)) {
        parseEndTag( '', lastTag );
      }
