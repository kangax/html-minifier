...
(function(global) {
  ...
  test('script minification', function() {
    ...
    output = '<script>!function(e,t,a,n,r){e[n]=e[n]||[],e[n].push({"gtm.start":(new Date).getTime(),event:"gtm.js"});var g=t.getElementsByTagName(a)[0],m=t.createElement(a),o="dataLayer"!=n?"&l="+n:"";m.async=!0,m.src="//www.googletagmanager.com/gtm.js?id="+r+o,g.parentNode.insertBefore(m,g)}(window,document,"script","dataLayer","GTM-67NT");</script>';
  ...
  test('on* minification', function() {
    ...
    input = "<a onclick=\"try{ dcsMultiTrack('DCS.dcsuri','USPS','WT.ti') }catch(c){}\"> foobar</a>";
