...
test('custom processors', function() {
  ...
  equal(minify(input), input);
  equal(minify(input, { minifyCSS: null }), input);
  equal(minify(input, { minifyCSS: false }), input);
  output = '<style>Normal CSS</style>';
  equal(minify(input, { minifyCSS: css }), output);
  ...
  input = '<script>\nalert(1); </script>';
  equal(minify(input), input);
  equal(minify(input, { minifyJS: null }), input);
  equal(minify(input, { minifyJS: false }), input);
  output = '<script>Normal JS</script>';
  equal(minify(input, { minifyJS: js }), output);
  ...
  equal(minify(input), input);
  equal(minify(input, { minifyURLs: null }), input);
  equal(minify(input, { minifyURLs: false }), input);
  output = '<a href="URL">bar</a>';
  equal(minify(input, { minifyURLs: url }), output);

  input = '<style>\n.foo { background: url("http://site.com/foo") } </style>';
  equal(minify(input), input);
  equal(minify(input, { minifyURLs: null }), input);
  equal(minify(input, { minifyURLs: false }), input);
  equal(minify(input, { minifyURLs: url }), input);
  output = '<style>.foo{background:url(URL)}</style>';
  equal(minify(input, { minifyCSS: true, minifyURLs: url }), output);
});
...
test('auto-generated tags', function() {
  ...
  equal(minify('<p id=""class=""title="">x', {
    maxLineLength: 25,
