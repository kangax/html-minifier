...
QUnit.test('parsing non-trivial markup', function(assert) {
  ...
  test_minify_sync(assert, '</td>', '');
  test_minify_sync(assert, '</p>', '<p></p>');
  test_minify_sync(assert, '</br>', '<br>');
  test_minify_sync(assert, '<br>x</br>', '<br>x<br>');
  test_minify_sync(assert, '<p title="</p>">x</p>', '<p title="</p>">x</p>');
  test_minify_sync(assert, '<p title=" <!-- hello world --> ">x</p>', '<p title=" <!-- hello world --> ">x</p>');
  test_minify_sync(assert, '<p title=" <![CDATA[ \n\n foobar baz ]]> ">x</p>', '<p title=" <![CDATA[ \n\n foobar baz ]]> ">x</p>');
  test_minify_sync(assert, '<p foo-bar=baz>xxx</p>', '<p foo-bar="baz">xxx</p>');
  test_minify_sync(assert, '<p foo:bar=baz>xxx</p>', '<p foo:bar="baz">xxx</p>');
  test_minify_sync(assert, '<p foo.bar=baz>xxx</p>', '<p foo.bar="baz">xxx</p>');
  ...
  test_minify_sync(assert, '<script>alert(\'<!--\')</script>', '<script>alert(\'<!--\')</script>');
  test_minify_sync(assert, '<script>alert(\'<!-- foo -->\')</script>', '<script>alert(\'<!-- foo -->\')</script>');
  test_minify_sync(assert, '<script>alert(\'-->\')</script>', '<script>alert(\'-->\')</script>');

  test_minify_sync(assert, '<a title="x"href=" ">foo</a>', '<a title="x" href="">foo</a>');
  test_minify_sync(assert, '<p id=""class=""title="">x', '<p id="" class="" title="">x</p>');
  test_minify_sync(assert, '<p x="x\'"">x</p>', '<p x="x\'">x</p>', 'trailing quote should be ignored');
  test_minify_sync(assert, '<a href="#"><p>Click me</p></a>', '<a href="#"><p>Click me</p></a>');
  test_minify_sync(assert, '<span><button>Hit me</button></span>', '<span><button>Hit me</button></span>');
  test_minify_sync(assert, '<object type="image/svg+xml" data="image.svg"><div>[fallback image]</div></object>',
    '<object type="image/svg+xml" data="image.svg"><div>[fallback image]</div></object>'
  );

  test_minify_sync(assert, '<ng-include src="x"></ng-include>', '<ng-include src="x"></ng-include>');
  test_minify_sync(assert, '<ng:include src="x"></ng:include>', '<ng:include src="x"></ng:include>');
  test_minify_sync(assert, '<ng-include src="\'views/partial-notification.html\'"></ng-include><div ng-view=""></div>',
  ...
  test_minify_sync(assert, '<some-tag-1></some-tag-1><some-tag-2></some-tag-2>',
  ...
  test_minify_sync(assert, '<a href="test.html"><div>hey</div></a>', '<a href="test.html"><div>hey</div></a>');

  // https://github.com/kangax/html-minifier/issues/17
  test_minify_sync(assert, ':) <a href="http://example.com">link</a>', ':) <a href="http://example.com">link</a>');

  // https://github.com/kangax/html-minifier/issues/169
  test_minify_sync(assert, '<a href>ok</a>', '<a href>ok</a>');

  test_minify_sync(assert, '<a onclick></a>', '<a onclick></a>');

  // https://github.com/kangax/html-minifier/issues/229
  test_minify_sync(assert, '<CUSTOM-TAG></CUSTOM-TAG><div>Hello :)</div>', '<custom-tag></custom-tag><div>Hello :)</div>');
...
QUnit.test('case normalization', function(assert) {
  test_minify_sync(assert, '<P>foo</p>', '<p>foo</p>');
  test_minify_sync(assert, '<DIV>boo</DIV>', '<div>boo</div>');
  test_minify_sync(assert, '<DIV title="moo">boo</DiV>', '<div title="moo">boo</div>');
  test_minify_sync(assert, '<DIV TITLE="blah">boo</DIV>', '<div title="blah">boo</div>');
  test_minify_sync(assert, '<DIV tItLe="blah">boo</DIV>', '<div title="blah">boo</div>');
  test_minify_sync(assert, '<DiV tItLe="blah">boo</DIV>', '<div title="blah">boo</div>');
});

QUnit.test('space normalization between attributes', function(assert) {
  test_minify_sync(assert, '<p title="bar">foo</p>', '<p title="bar">foo</p>');
  test_minify_sync(assert, '<img src="test"/>', '<img src="test">');
  test_minify_sync(assert, '<p title = "bar">foo</p>', '<p title="bar">foo</p>');
  test_minify_sync(assert, '<p title\n\n\t  =\n     "bar">foo</p>', '<p title="bar">foo</p>');
  test_minify_sync(assert, '<img src="test" \n\t />', '<img src="test">');
  test_minify_sync(assert, '<input title="bar"       id="boo"    value="hello world">', '<input title="bar" id="boo" value="hello world">');
});
...
QUnit.test('space normalization around text', function(assert) {
  ...
  [
    ...
    test_minify_sync(assert, 'foo <' + el + '> baz </' + el + '>bar', { collapseWhitespace: true }, 'foo <' + el + '>baz </' + el + '>bar');
    test_minify_sync(assert, 'foo<' + el + '> baz </' + el + '> bar', { collapseWhitespace: true }, 'foo<' + el + '> baz </' + el + '>bar');
    test_minify_sync(assert, '<div>foo <' + el + '>baz</' + el + '> bar</div>', { collapseWhitespace: true }, '<div>foo <' + el + '>baz</' + el + '> bar</div>');
    test_minify_sync(assert, '<div>foo<' + el + '>baz</' + el + '>bar</div>', { collapseWhitespace: true }, '<div>foo<' + el + '>baz</' + el + '>bar</div>');
    test_minify_sync(assert, '<div>foo <' + el + '>baz</' + el + '>bar</div>', { collapseWhitespace: true }, '<div>foo <' + el + '>baz</' + el + '>bar</div>');
    test_minify_sync(assert, '<div>foo<' + el + '>baz</' + el + '> bar</div>', { collapseWhitespace: true }, '<div>foo<' + el + '>baz</' + el + '> bar</div>');
    test_minify_sync(assert, '<div>foo <' + el + '> baz </' + el + '> bar</div>', { collapseWhitespace: true }, '<div>foo <' + el + '>baz </' + el + '>bar</div>');
  ...
  test_minify_sync(assert, '<p>foo <img> bar</p>', { collapseWhitespace: true }, '<p>foo <img> bar</p>');
  test_minify_sync(assert, '<p>foo<img>bar</p>', { collapseWhitespace: true }, '<p>foo<img>bar</p>');
  test_minify_sync(assert, '<p>foo <img>bar</p>', { collapseWhitespace: true }, '<p>foo <img>bar</p>');
  test_minify_sync(assert, '<p>foo<img> bar</p>', { collapseWhitespace: true }, '<p>foo<img> bar</p>');
  test_minify_sync(assert, '<p>foo <wbr> bar</p>', { collapseWhitespace: true }, '<p>foo<wbr> bar</p>');
  test_minify_sync(assert, '<p>foo<wbr>bar</p>', { collapseWhitespace: true }, '<p>foo<wbr>bar</p>');
  test_minify_sync(assert, '<p>foo <wbr>bar</p>', { collapseWhitespace: true }, '<p>foo <wbr>bar</p>');
  test_minify_sync(assert, '<p>foo<wbr> bar</p>', { collapseWhitespace: true }, '<p>foo<wbr> bar</p>');
  test_minify_sync(assert, '<p>foo <wbr baz moo=""> bar</p>', { collapseWhitespace: true }, '<p>foo<wbr baz moo=""> bar</p>');
  test_minify_sync(assert, '<p>foo<wbr baz moo="">bar</p>', { collapseWhitespace: true }, '<p>foo<wbr baz moo="">bar</p>');
  test_minify_sync(assert, '<p>foo <wbr baz moo="">bar</p>', { collapseWhitespace: true }, '<p>foo <wbr baz moo="">bar</p>');
  test_minify_sync(assert, '<p>foo<wbr baz moo=""> bar</p>', { collapseWhitespace: true }, '<p>foo<wbr baz moo=""> bar</p>');
  test_minify_sync(assert, '<p>  <a href="#">  <code>foo</code></a> bar</p>', { collapseWhitespace: true }, '<p><a href="#"><code>foo</code></a> bar</p>');
  test_minify_sync(assert, '<p><a href="#"><code>foo  </code></a> bar</p>', { collapseWhitespace: true }, '<p><a href="#"><code>foo</code></a> bar</p>');
  test_minify_sync(assert, '<p>  <a href="#">  <code>   foo</code></a> bar   </p>', { collapseWhitespace: true }, '<p><a href="#"><code>foo</code></a> bar</p>');
  test_minify_sync(assert, '<div> Empty <!-- or --> not </div>', { collapseWhitespace: true }, '<div>Empty<!-- or --> not</div>');
  test_minify_sync(assert, '<div> a <input><!-- b --> c </div>', {
    collapseWhitespace: true,
    removeComments: true
  }, '<div>a <input> c</div>');
  [
...
QUnit.test('doctype normalization', function(assert) {
  ...
  test_minify_sync(assert, input, { useShortDoctype: true }, '<!DOCTYPE html>');
...
QUnit.test('removing comments', function(assert) {
  ...
  test_minify_sync(assert, input, { removeComments: true }, '<div>baz</div>');
  ...
  test_minify_sync(assert, input, { removeComments: true }, '<style><!-- alert(1) --></style>');
});
...
QUnit.test('ignoring comments', function(assert) {
  ...
  input = '<!--! foo --><div>baz</div><!-- bar\n\n moo -->';
  test_minify_sync(assert, input, { removeComments: true }, '<!--! foo --><div>baz</div>');
  test_minify_sync(assert, input, { removeComments: false }, input);
...
QUnit.test('empty attributes', function(assert) {
  ...
  test_minify_sync(assert, input, { removeEmptyAttributes: true }, '<p>x</p>');
  ...
  test_minify_sync(assert, input, { removeEmptyAttributes: true }, '<input value=" boo ">');

  input = '<input value="" name="foo">';
  test_minify_sync(assert, input, { removeEmptyAttributes: true }, '<input name="foo">');

  input = '<img src="" alt="">';
  test_minify_sync(assert, input, { removeEmptyAttributes: true }, '<img src="" alt="">');
  ...
  test_minify_sync(assert, input, { removeEmptyAttributes: true }, '<div data-foo></div>');

  // additional remove attributes
  input = '<img src="" alt="">';
  test_minify_sync(assert, input, { removeEmptyAttributes: function(attrName, tag) { return tag === 'img' && attrName === 'src'; } }, '<img alt="">');
});
...
QUnit.test('cleaning class/style attributes', function(assert) {
  ...
  test_minify_sync(assert, input, '<p class="foo bar">foo bar baz</p>');

  input = '<p class=" foo      ">foo bar baz</p>';
  test_minify_sync(assert, input, '<p class="foo">foo bar baz</p>');
  test_minify_sync(assert, input, { removeAttributeQuotes: true }, '<p class=foo>foo bar baz</p>');
...
QUnit.test('removing redundant attributes (&lt;form method="get" ...>)', function(assert) {
  ...
  test_minify_sync(assert, input, { removeRedundantAttributes: true }, '<form>hello world</form>');

  input = '<form method="post">hello world</form>';
  test_minify_sync(assert, input, { removeRedundantAttributes: true }, '<form method="post">hello world</form>');
});
...
QUnit.test('removing redundant attributes (&lt;input type="text" ...>)', function(assert) {
  ...
  test_minify_sync(assert, input, { removeRedundantAttributes: true }, '<input value="foo">');

  input = '<input type="checkbox">';
  test_minify_sync(assert, input, { removeRedundantAttributes: true }, '<input type="checkbox">');
});
...
QUnit.test('removing redundant attributes (&lt;a name="..." id="..." ...>)', function(assert) {
  ...
  test_minify_sync(assert, input, { removeRedundantAttributes: true }, '<a id="foo">blah</a>');
  ...
  test_minify_sync(assert, input, { removeRedundantAttributes: true }, '<a href="..." id="bar">blah</a>');
});
...
QUnit.test('removing redundant attributes (&lt;... language="javascript" ...>)', function(assert) {
  ...
  test_minify_sync(assert, input, { removeRedundantAttributes: true }, '<script>x=2,y=4</script>');
...
QUnit.test('removing redundant attributes (&lt;... = "javascript: ..." ...>)', function(assert) {
  ...
  test_minify_sync(assert, input, '<p onclick="alert(1)">x</p>');

  input = '<p onclick="javascript:x">x</p>';
  test_minify_sync(assert, input, { removeAttributeQuotes: true }, '<p onclick=x>x</p>');

  input = '<p onclick=" JavaScript: x">x</p>';
  test_minify_sync(assert, input, '<p onclick="x">x</p>');
...
QUnit.test('removing attribute quotes', function(assert) {
  ...
  test_minify_sync(assert, input, { removeAttributeQuotes: true }, '<p title=blah class=a23B-foo.bar_baz:qux id=moo>foo</p>');

  input = '<input value="hello world">';
  test_minify_sync(assert, input, { removeAttributeQuotes: true }, '<input value="hello world">');

  input = '<a href="#" title="foo#bar">x</a>';
  test_minify_sync(assert, input, { removeAttributeQuotes: true }, '<a href=# title=foo#bar>x</a>');

  input = '<a href="http://example.com/" title="blah">\nfoo\n\n</a>';
  test_minify_sync(assert, input, { removeAttributeQuotes: true }, '<a href=http://example.com/ title=blah>\nfoo\n\n</a>');

  input = '<a title="blah" href="http://example.com/">\nfoo\n\n</a>';
  test_minify_sync(assert, input, { removeAttributeQuotes: true }, '<a title=blah href=http://example.com/ >\nfoo\n\n</a>');

  input = '<a href="http://example.com/" title="">\nfoo\n\n</a>';
  test_minify_sync(assert, input, { removeAttributeQuotes: true, removeEmptyAttributes: true }, '<a href=http://example.com/ >\nfoo\n\n</a>');

  input = '<p class=foo|bar:baz></p>';
  test_minify_sync(assert, input, { removeAttributeQuotes: true }, '<p class=foo|bar:baz></p>');
});
...
QUnit.test('preserving custom attribute-wrapping markup', function(assert) {
  ...
  input = '<input {{#if value}}checked="checked"{{/if}}>';
  test_minify_sync(assert, input, customAttrOptions, '<input {{#if value}}checked{{/if}}>');

  input = '<input {{#if value1}}checked="checked"{{/if}} {{#if value2}}data-attr="foo"{{/if}}/>';
  test_minify_sync(assert, input, customAttrOptions, '<input {{#if value1}}checked {{/if}}{{#if value2}}data-attr=foo{{/if}}>');
...
QUnit.test('removing empty elements', function(assert) {
  ...
  test_minify_sync(assert, '<p>x</p>', { removeEmptyElements: true }, '<p>x</p>');
  test_minify_sync(assert, '<p></p>', { removeEmptyElements: true }, '');
...
QUnit.test('collapsing boolean attributes', function(assert) {
  ...
  test_minify_sync(assert, input, { collapseBooleanAttributes: true }, '<input disabled>');

  input = '<input CHECKED = "checked" readonly="readonly">';
  test_minify_sync(assert, input, { collapseBooleanAttributes: true }, '<input checked readonly>');

  input = '<option name="blah" selected="selected">moo</option>';
  test_minify_sync(assert, input, { collapseBooleanAttributes: true }, '<option name="blah" selected>moo</option>');

  input = '<input autofocus="autofocus">';
  test_minify_sync(assert, input, { collapseBooleanAttributes: true }, '<input autofocus>');

  input = '<input required="required">';
  test_minify_sync(assert, input, { collapseBooleanAttributes: true }, '<input required>');

  input = '<input multiple="multiple">';
  test_minify_sync(assert, input, { collapseBooleanAttributes: true }, '<input multiple>');
...
QUnit.test('collapsing enumerated attributes', function(assert) {
  test_minify_sync(assert, '<div draggable="auto"></div>', { collapseBooleanAttributes: true }, '<div draggable></div>');
  test_minify_sync(assert, '<div draggable="true"></div>', { collapseBooleanAttributes: true }, '<div draggable="true"></div>');
  test_minify_sync(assert, '<div draggable="false"></div>', { collapseBooleanAttributes: true }, '<div draggable="false"></div>');
  test_minify_sync(assert, '<div draggable="foo"></div>', { collapseBooleanAttributes: true }, '<div draggable></div>');
  test_minify_sync(assert, '<div draggable></div>', { collapseBooleanAttributes: true }, '<div draggable></div>');
  test_minify_sync(assert, '<div Draggable="auto"></div>', { collapseBooleanAttributes: true }, '<div draggable></div>');
  test_minify_sync(assert, '<div Draggable="true"></div>', { collapseBooleanAttributes: true }, '<div draggable="true"></div>');
  test_minify_sync(assert, '<div Draggable="false"></div>', { collapseBooleanAttributes: true }, '<div draggable="false"></div>');
  test_minify_sync(assert, '<div Draggable="foo"></div>', { collapseBooleanAttributes: true }, '<div draggable></div>');
...
QUnit.test('keeping trailing slashes in tags', function(assert) {
  test_minify_sync(assert, '<img src="test"/>', { keepClosingSlash: true }, '<img src="test"/>');
  // https://github.com/kangax/html-minifier/issues/233
  test_minify_sync(assert, '<img src="test"/>', { keepClosingSlash: true, removeAttributeQuotes: true }, '<img src=test />');
  test_minify_sync(assert, '<img src="test" id=""/>', { keepClosingSlash: true, removeAttributeQuotes: true, removeEmptyAttributes: true }, '<img src=test />');
  test_minify_sync(assert, '<img title="foo" src="test"/>', { keepClosingSlash: true, removeAttributeQuotes: true }, '<img title=foo src=test />');
});
...
QUnit.test('nested quotes', function(assert) {
  ...
  test_minify_sync(assert, input, input);
  test_minify_sync(assert, input, { quoteCharacter: '\'' }, input);

  output = '<div data="{&#34;test&#34;:&#34;\\&#34;test\\&#34;&#34;}"></div>';
  test_minify_sync(assert, input, { quoteCharacter: '"' }, output);
});
...
QUnit.test('script minification', function(assert) {
  ...
  test_minify_sync(assert, input, { minifyJS: { mangle: false } }, output);
...
QUnit.test('minification of scripts with custom fragments', function(assert) {
  ...
  test_minify_sync(assert, input, { minifyJS: true }, input);
  test_minify_sync(assert, input, { collapseWhitespace: true, minifyJS: true }, input);
  test_minify_sync(assert, input, {
    collapseWhitespace: true,
    minifyJS: true,
    preserveLineBreaks: true
  ...
  test_minify_sync(assert, input, { collapseWhitespace: true, minifyJS: true }, output);
  test_minify_sync(assert, input, {
    collapseWhitespace: true,
    minifyJS: true,
    preserveLineBreaks: true
...
QUnit.test('event minification', function(assert) {
  ...
  test_minify_sync(assert, input, { minifyJS: { mangle: false } }, output);
  test_minify_sync(assert, input, { minifyJS: { mangle: false }, quoteCharacter: '\'' }, output);
  ...
  test_minify_sync(assert, input, { minifyJS: true }, output);
  test_minify_sync(assert, input, { minifyJS: true, quoteCharacter: '\'' }, output);
  ...
  test_minify_sync(assert, input, { minifyJS: true }, output);
  test_minify_sync(assert, input, { minifyJS: true, customEventAttributes: [] }, input);
  output = '<button type="button" onclick=";return false;" ng-click="a(3)" data-click="a(1 + 2)"></button>';
  test_minify_sync(assert, input, { minifyJS: true, customEventAttributes: [/^ng-/] }, output);
  output = '<button type="button" onclick="return!1" ng-click="a(3)" data-click="a(1 + 2)"></button>';
  test_minify_sync(assert, input, { minifyJS: true, customEventAttributes: [/^on/, /^ng-/] }, output);
...
QUnit.test('url attribute minification', function(assert) {
  ...
  test_minify_sync(assert, input, { minifyURLs: 'http://website.com/folder/' }, output);
  test_minify_sync(assert, input, { minifyURLs: { site: 'http://website.com/folder/' } }, output);

  input = '<link rel="canonical" href="http://website.com/">';
  test_minify_sync(assert, input, { minifyURLs: 'http://website.com/' }, input);
  test_minify_sync(assert, input, { minifyURLs: { site: 'http://website.com/' } }, input);
  ...
  test_minify_sync(assert, input, { minifyURLs: { site: 'http://website.com/foo bar/' } }, input);
  ...
  test_minify_sync(assert, input, { minifyURLs: { site: 'http://website.com/' } }, input);
  test_minify_sync(assert, input, { minifyURLs: { site: 'http://website.com/foo%20bar/' } }, input);
  test_minify_sync(assert, input, { minifyURLs: { site: 'http://website.com/foo%20bar/(baz)/' } }, input);
  ...
  test_minify_sync(assert, input, { minifyURLs: { site: 'http://site.com/' } }, output);
});
...
QUnit.test('ignore custom comments', function(assert) {
  ...
  test_minify_sync(assert, input, input);
  test_minify_sync(assert, input, { removeComments: true }, input);
  test_minify_sync(assert, input, { ignoreCustomComments: false }, input);
  test_minify_sync(assert, input, {
    removeComments: true,
  ...
  output = 'test';
  test_minify_sync(assert, input, output);
  test_minify_sync(assert, input, { removeComments: true }, output);
  test_minify_sync(assert, input, { ignoreCustomComments: false }, output);
  test_minify_sync(assert, input, {
    removeComments: true,
    ignoreCustomComments: []
  }, output);
...
QUnit.test('ignore', function(assert) {
  ...
  test_minify_sync(assert, input, { ignoreCustomFragments: [/<\?php[\s\S]*?\?>/] }, output);
...
QUnit.test('noscript', function(assert) {
  ...
  test_minify_sync(assert, input, '<script src="x"></script><noscript>x</noscript>');

  input = '<noscript>\n<!-- anchor linking to external file -->\n' +
          '<a href="#" onclick="javascript:">External Link</a>\n</noscript>';
  test_minify_sync(assert, input, { removeComments: true, collapseWhitespace: true, removeEmptyAttributes: true },
...
QUnit.test('max line length', function(assert) {
  ...
  test_minify_sync(assert, input, options, input);

  input = '<div data-attr="foo"></div>';
  test_minify_sync(assert, input, options, '<div data-attr="foo">\n</div>');

  input = '<code>    hello   world  \n    world   hello  </code>';
  test_minify_sync(assert, input, options, '<code>\n    hello   world  \n    world   hello  \n</code>');
  ...
  test_minify_sync(assert, '<script>alert(\'<!--\')</script>', options, '<script>alert(\'<!--\')\n</script>');
  input = '<script>\nalert(\'<!-- foo -->\')\n</script>';
  test_minify_sync(assert, '<script>alert(\'<!-- foo -->\')</script>', options, input);
  test_minify_sync(assert, input, options, input);
  test_minify_sync(assert, '<script>alert(\'-->\')</script>', options, '<script>alert(\'-->\')\n</script>');

  test_minify_sync(assert, '<a title="x"href=" ">foo</a>', options, '<a title="x" href="">foo\n</a>');
  test_minify_sync(assert, '<p id=""class=""title="">x', options, '<p id="" class="" \ntitle="">x</p>');
  test_minify_sync(assert, '<p x="x\'"">x</p>', options, '<p x="x\'">x</p>', 'trailing quote should be ignored');
  test_minify_sync(assert, '<a href="#"><p>Click me</p></a>', options, '<a href="#"><p>Click me\n</p></a>');
  input = '<span><button>Hit me\n</button></span>';
  test_minify_sync(assert, '<span><button>Hit me</button></span>', options, input);
  test_minify_sync(assert, input, options, input);
  test_minify_sync(assert, '<object type="image/svg+xml" data="image.svg"><div>[fallback image]</div></object>', options,
    '<object \ntype="image/svg+xml" \ndata="image.svg"><div>\n[fallback image]</div>\n</object>'
  );

  test_minify_sync(assert, '<ng-include src="x"></ng-include>', options, '<ng-include src="x">\n</ng-include>');
  test_minify_sync(assert, '<ng:include src="x"></ng:include>', options, '<ng:include src="x">\n</ng:include>');
  test_minify_sync(assert, '<ng-include src="\'views/partial-notification.html\'"></ng-include><div ng-view=""></div>', options,
    '<ng-include \nsrc="\'views/partial-notification.html\'">\n</ng-include><div \nng-view=""></div>'
  );
  test_minify_sync(assert, '<some-tag-1></some-tag-1><some-tag-2></some-tag-2>', options,
    '<some-tag-1>\n</some-tag-1>\n<some-tag-2>\n</some-tag-2>'
  );
  test_minify_sync(assert, '[\']["]', options, '[\']["]');
  test_minify_sync(assert, '<a href="test.html"><div>hey</div></a>', options, '<a href="test.html">\n<div>hey</div></a>');
  test_minify_sync(assert, ':) <a href="http://example.com">link</a>', options, ':) <a \nhref="http://example.com">\nlink</a>');
  test_minify_sync(assert, ':) <a href="http://example.com">\nlink</a>', options, ':) <a \nhref="http://example.com">\nlink</a>');
  test_minify_sync(assert, ':) <a href="http://example.com">\n\nlink</a>', options, ':) <a \nhref="http://example.com">\n\nlink</a>');

  test_minify_sync(assert, '<a href>ok</a>', options, '<a href>ok</a>');
});
...
QUnit.test('custom attribute collapse', function(assert) {
  ...
  test_minify_sync(assert, input, { customAttrCollapse: /style/ }, output);
  ...
  test_minify_sync(assert, input, { customAttrCollapse: /ng-class/ }, output);
});
...
QUnit.test('do not escape attribute value', function(assert) {
  ...
  input = '<div data=\'{\n' +
          ...
          '}\'></div>';
  test_minify_sync(assert, input, input);
  test_minify_sync(assert, input, { preventAttributesEscaping: true }, input);
...
QUnit.test('quoteCharacter is single quote', function(assert) {
  test_minify_sync(assert, '<div class=\'bar\'>foo</div>', { quoteCharacter: '\'' }, '<div class=\'bar\'>foo</div>');
  test_minify_sync(assert, '<div class="bar">foo</div>', { quoteCharacter: '\'' }, '<div class=\'bar\'>foo</div>');
});

QUnit.test('quoteCharacter is not single quote or double quote', function(assert) {
  test_minify_sync(assert, '<div class=\'bar\'>foo</div>', { quoteCharacter: 'm' }, '<div class="bar">foo</div>');
  test_minify_sync(assert, '<div class="bar">foo</div>', { quoteCharacter: 'm' }, '<div class="bar">foo</div>');
});
...
QUnit.test('remove space between attributes', function(assert) {
  ...
  test_minify_sync(assert, input, options, output);
...
QUnit.test('markups from Angular 2', function(assert) {
  ...
  output = '<template ngFor #hero [ngForOf]="heroes">\n' +
           ...
           '  <button type="submit" [disabled]="!theForm.form.valid">Submit</button>\n' +
           '</form>';
  test_minify_sync(assert, input, { caseSensitive: true }, output);
  output = '<template ngFor #hero [ngForOf]=heroes>' +
           '<hero-detail *ngIf=hero [hero]=hero></hero-detail>' +
           '</template>' +
           '<form (ngSubmit)=onSubmit(theForm) #theForm=ngForm>' +
...
QUnit.test('auto-generated tags', function(assert) {
  ...
  input = '</p>';
  test_minify_sync(assert, input, { includeAutoGeneratedTags: false }, input);

  input = '<p id=""class=""title="">x';
  output = '<p id="" class="" title="">x';
  test_minify_sync(assert, input, { includeAutoGeneratedTags: false }, output);
  output = '<p id="" class="" title="">x</p>';
  test_minify_sync(assert, input, output);
  test_minify_sync(assert, input, { includeAutoGeneratedTags: true }, output);
  ...
  test_minify_sync(assert, input, { html5: false, includeAutoGeneratedTags: false }, output);
  test_minify_sync(assert, '<p id=""class=""title="">x', {
    maxLineLength: 25,
...
QUnit.test('sort attributes', function(assert) {
  ...
  test_minify_sync(assert, input, input);
  test_minify_sync(assert, input, { sortAttributes: false }, input);
  output = '<link href="foo">' +
           '<link href="baz" rel="bar">' +
           '<link href="app.css" rel="stylesheet" async type="text/css">';
  test_minify_sync(assert, input, { sortAttributes: true }, output);
  ...
  test_minify_sync(assert, input, { sortAttributes: true }, input);
});
...
QUnit.test('sort style classes', function(assert) {
  ...
  output = '<a class="foo moo"></a>' +
           ...
           '<u class="baz moo"></u>';
  test_minify_sync(assert, input, { sortClassName: true }, output);

  input = '<a class="moo <!-- htmlmin:ignore -->bar<!-- htmlmin:ignore --> foo baz"></a>';
  output = '<a class="moo bar foo baz"></a>';
  test_minify_sync(assert, input, output);
  test_minify_sync(assert, input, { sortClassName: false }, output);
...
QUnit.test('decode entity characters', function(assert) {
  ...
  input = '<!-- &ne; -->';
  test_minify_sync(assert, input, input);
  test_minify_sync(assert, input, { decodeEntities: false }, input);
  test_minify_sync(assert, input, { decodeEntities: true }, input);
  ...
  test_minify_sync(assert, input, { decodeEntities: true }, output);
  output = '<div style="font:&quot">foo&dollar;</div>';
  test_minify_sync(assert, input, { minifyCSS: true }, output);
  test_minify_sync(assert, input, { decodeEntities: false, minifyCSS: true }, output);
  output = '<div style="font:monospace">foo$</div>';
  test_minify_sync(assert, input, { decodeEntities: true, minifyCSS: true }, output);
  ...
  input = '<? &amp; ?>&amp;<pre><? &amp; ?>&amp;</pre>';
  test_minify_sync(assert, input, input);
  test_minify_sync(assert, input, { collapseWhitespace: false, decodeEntities: false }, input);
  test_minify_sync(assert, input, { collapseWhitespace: true, decodeEntities: false }, input);
  output = '<? &amp; ?>&<pre><? &amp; ?>&</pre>';
  test_minify_sync(assert, input, { collapseWhitespace: false, decodeEntities: true }, output);
  test_minify_sync(assert, input, { collapseWhitespace: true, decodeEntities: true }, output);
});
...
QUnit.test('tests from PHPTAL', function(assert) {
  [
    ...
    test_minify_sync(assert, tokens[1], {
      collapseBooleanAttributes: true,
      collapseWhitespace: true,
      removeAttributeQuotes: true,
      removeComments: true,
