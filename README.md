...
| `minifyJS`                     | Minify JavaScript in script elements and event attributes (uses [UglifyJS](https://github.com/mishoo/UglifyJS2/tree/harmony)) | `false` (could be `true`, `Object`, `Function(text, inline)`) |
